...
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubFileResponse.CreateGithubFileResponse;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubFileResponse.DeleteGithubFileResponse;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubFileResponse.GetGithubFileResponse;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubTag.CreateGithubTagRequest;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubTag.CreateGithubTagResponse;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubTag.GetGithubRefsTagResponse;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubTag.GetGithubTagResponse;
import com.nttdata.knot.baseapi.Models.GithubPackage.GithubTag.Person;
    ...
    public Mono<String> createGithubTagAsync(String repoName, String source, String target, String message) {
        ...
        if (source.contains("-rc") || source.contains("-RC")) {
            ...
            return webClient.get()
                    ...
                    .doOnError(e -> logger.error("Unable to process request, exception is " + e.getMessage()))
                    .flatMap(response -> createGithubTagAndRef(repoName, target, message, sourceContainer[0]))
                    .onErrorResume(e -> Mono.just("Error occurred: " + e.getMessage()));
        } else {
            String response = createGithubTagAndRef(repoName, target, message, source).block();
            return Mono.just(response);
        }
    }

    private Mono<String> createGithubTagAndRef(String repoName, String target, String message, String sourceSha) {
        String uri = this.githubUrl + "/" + this.organization + "/" + repoName + "/git/tags";
        ...
        createGithubTagRequest.setObject(sourceSha);
        ...
        Mono<CreateGithubTagResponse> responseMono = webClient.post()
                .uri(uri)
